...
func _ready():
	...
	overridable_properties.append(Property.new("Texture", 			Property.Type.TEXTURE, Callable(self, "get_texture"), Callable(self, "set_texture")))
	overridable_properties.append(Property.new("Region Position",	Property.Type.VECTOR2, Callable(self, "get_rect_pos"), Callable(self, "set_rect_pos")))
	overridable_properties.append(Property.new("Region Size", 		Property.Type.VECTOR2, Callable(self, "get_rect_size"), Callable(self, "set_rect_size")))
	overridable_properties.append("SPACE")
	
	overridable_properties.append(Property.new("Region Margin", 	Property.Type.VECTOR4, Callable(self, "get_region_margin"), Callable(self, "set_region_margin")))
	overridable_properties.append("SPACE")
	
	overridable_properties.append(Property.EnumProperty.new("Stretch Horizontal", ["Stretch", "Tile", "Tile Fit"], Callable(self, "get_h_stretch"), Callable(self, "set_h_stretch")))
	overridable_properties.append(Property.EnumProperty.new("Stretch Vertical", ["Stretch", "Tile", "Tile Fit"], Callable(self, "get_v_stretch"), Callable(self, "set_v_stretch")))
	overridable_properties.append(Property.new("Draw Center", 		Property.Type.BOOL, Callable(self, "get_b_draw_center"), Callable(self, "set_b_draw_center")))
